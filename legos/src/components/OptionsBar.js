...
function OptionsBar({ setSendValues, sendValues, sendRequest, invalidInput }) {
    ...
    return (
        <Center mt={50} h={60}>
            <Stack spacing={24} direction='row'>
                ...
                <Button w={48} h={10} colorScheme='blue' onClick={() => sendRequest()} isDisabled={invalidInput}>Launch</Button>
            </Stack>
        </Center>
    );
}
